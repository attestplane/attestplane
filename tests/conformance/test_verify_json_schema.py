...
from attestplane.verify_reason_codes import verify_reason_code_explanation
...
def test_verify_reason_code_parity_vector_for_non_nfc_bundle(capsys) -> None:
    ...
    assert captured.err.splitlines()[0] == f"{reason_code}: {verify_reason_code_explanation(reason_code)}"

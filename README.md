...
[![PyPI](https://img.shields.io/badge/PyPI-attestplane%200.5.3a0-blue)](https://pypi.org/project/attestplane/)
...
Python `attestplane==0.5.3a0` is published to PyPI, and
`@attestplane/attestplane@0.5.3-alpha` is published to npm under the
...
|---|---|---|
| `attestplane==0.5.3a0` | [PyPI](https://pypi.org/project/attestplane/) | GitHub OIDC trusted publishing |
...
```bash
pip install attestplane==0.5.3a0
```

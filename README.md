...
artifacts: Python `attestplane==0.7.10a0` is published to PyPI, and
`@attestplane/attestplane@0.7.10-alpha` is published to npm under the
...
|---|---|---|
| `attestplane==0.7.10a0` | [PyPI](https://pypi.org/project/attestplane/) | GitHub OIDC trusted publishing |

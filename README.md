...
| API reference | [GitHub Pages stable docs](docs/contributor/api-reference.md#published-stable-docs) | versioned release-line docs; prerelease refs stay artifact-only |

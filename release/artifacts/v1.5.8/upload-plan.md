# v1.5.8 Release-Asset Upload Plan
...
```bash
git tag -a v1.5.8 -m "v1.5.8"
git push origin main
git push origin v1.5.8
gh workflow run release-cd.yml -f release_tag=v1.5.8 -f channel=latest -f dry_run=false --ref main
```

# v1.4.1 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.4.1-py3-none-any.whl
sdk/python/dist/attestplane-1.4.1.tar.gz
sdk/typescript/attestplane-attestplane-1.4.1.tgz
release/artifacts/v1.4.1/checksums.sha256
release/artifacts/v1.4.1/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.4.1 -f channel=latest -f dry_run=false --ref main
```

# v0.7.5-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.7.5a0-py3-none-any.whl
sdk/python/dist/attestplane-0.7.5a0.tar.gz
sdk/typescript/attestplane-attestplane-0.7.5-alpha.tgz
release/artifacts/v0.7.5-alpha/checksums.sha256
release/artifacts/v0.7.5-alpha/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.7.5-alpha -m "v0.7.5-alpha"
git -c http.version=HTTP/1.1 push origin v0.7.5-alpha
gh release create v0.7.5-alpha --prerelease --title "v0.7.5-alpha" --notes-file docs/release-notes/v0.7.5-alpha.draft.md ...

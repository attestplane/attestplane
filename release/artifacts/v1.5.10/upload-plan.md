# v1.5.10 Release-Asset Upload Plan
...
```bash
git tag -a v1.5.10 -m "v1.5.10"
git push origin main
git push origin v1.5.10
gh workflow run release-cd.yml -f release_tag=v1.5.10 -f channel=latest -f dry_run=false --ref main
```

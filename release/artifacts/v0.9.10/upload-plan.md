# v0.9.10 Release-Asset Upload Plan
...
```bash
git tag -a v0.9.10 -m "v0.9.10"
git push origin main
git push origin v0.9.10
gh workflow run release-cd.yml -f release_tag=v0.9.10 -f channel=latest -f dry_run=false --ref main
```

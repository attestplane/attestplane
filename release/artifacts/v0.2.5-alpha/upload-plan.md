# v0.2.5-alpha Release-Asset Upload Plan
...
```bash
git tag -a v0.2.5-alpha -m "v0.2.5-alpha"
git -c http.version=HTTP/1.1 push origin v0.2.5-alpha
gh release create v0.2.5-alpha --prerelease --title "v0.2.5-alpha" --notes-file docs/release-notes/v0.2.5-alpha.draft.md ...
...
gh workflow run manage-npm.yml -f action=dist-tag-set-latest-to-version -f version=0.2.5-alpha --ref main
```

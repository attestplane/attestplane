# v1.5.4 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.5.4-py3-none-any.whl
sdk/python/dist/attestplane-1.5.4.tar.gz
sdk/typescript/attestplane-attestplane-1.5.4.tgz
release/artifacts/v1.5.4/checksums.sha256
release/artifacts/v1.5.4/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v1.5.4 -m "v1.5.4"
git push origin main
git push origin v1.5.4
gh workflow run release-cd.yml -f release_tag=v1.5.4 -f channel=latest -f dry_run=false --ref main
```

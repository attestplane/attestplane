# v1.7.8 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.7.8-py3-none-any.whl
sdk/python/dist/attestplane-1.7.8.tar.gz
sdk/typescript/attestplane-attestplane-1.7.8.tgz
release/artifacts/v1.7.8/checksums.sha256
release/artifacts/v1.7.8/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v1.7.8 -m "v1.7.8"
git push origin main
git push origin v1.7.8
gh workflow run release-cd.yml -f release_tag=v1.7.8 -f channel=latest -f dry_run=false --ref main
```

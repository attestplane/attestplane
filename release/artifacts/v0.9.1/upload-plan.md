# v0.9.1 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.9.1-py3-none-any.whl
sdk/python/dist/attestplane-0.9.1.tar.gz
sdk/typescript/attestplane-attestplane-0.9.1.tgz
release/artifacts/v0.9.1/checksums.sha256
release/artifacts/v0.9.1/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v0.9.1 -f channel=latest -f dry_run=false --ref main
```

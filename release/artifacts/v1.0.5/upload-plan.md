# v1.0.5 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.0.5-py3-none-any.whl
sdk/python/dist/attestplane-1.0.5.tar.gz
sdk/typescript/attestplane-attestplane-1.0.5.tgz
release/artifacts/v1.0.5/checksums.sha256
release/artifacts/v1.0.5/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.0.5 -f channel=latest -f dry_run=false --ref main
```

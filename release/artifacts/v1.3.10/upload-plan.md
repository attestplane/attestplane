# v1.3.10 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.3.10-py3-none-any.whl
sdk/python/dist/attestplane-1.3.10.tar.gz
sdk/typescript/attestplane-attestplane-1.3.10.tgz
release/artifacts/v1.3.10/checksums.sha256
release/artifacts/v1.3.10/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.3.10 -f channel=latest -f dry_run=false --ref main
```

# v0.8.5-rc.3 Release-Asset Upload Plan
...
```bash
git tag -a v0.8.5-rc.3 -m "v0.8.5-rc.3"
git push origin main
git push origin v0.8.5-rc.3
gh workflow run release-cd.yml -f release_tag=v0.8.5-rc.3 -f channel=rc -f dry_run=false --ref main
```

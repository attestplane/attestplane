# v1.7.7 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.7.7-py3-none-any.whl
sdk/python/dist/attestplane-1.7.7.tar.gz
sdk/typescript/attestplane-attestplane-1.7.7.tgz
release/artifacts/v1.7.7/checksums.sha256
release/artifacts/v1.7.7/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.7.7 -f channel=latest -f dry_run=false --ref main
```

# v0.1.3-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.1.3a0-py3-none-any.whl
sdk/python/dist/attestplane-0.1.3a0.tar.gz
sdk/typescript/attestplane-attestplane-0.1.3-alpha.tgz
release/artifacts/v0.1.3-alpha/checksums.sha256
release/artifacts/v0.1.3-alpha/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.1.3-alpha -m "v0.1.3-alpha"
git push origin v0.1.3-alpha
gh release create v0.1.3-alpha --prerelease --title "v0.1.3-alpha" --notes-file docs/release-notes/v0.1.3-alpha.draft.md ...
...
gh workflow run manage-npm.yml -f action=dist-tag-set-latest-to-version -f version=0.1.3-alpha --ref main
```

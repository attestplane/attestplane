# v0.8.10 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.8.10-py3-none-any.whl
sdk/python/dist/attestplane-0.8.10.tar.gz
sdk/typescript/attestplane-attestplane-0.8.10.tgz
release/artifacts/v0.8.10/checksums.sha256
release/artifacts/v0.8.10/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.8.10 -m "v0.8.10"
git push origin main
git push origin v0.8.10
gh workflow run release-cd.yml -f release_tag=v0.8.10 -f channel=latest -f dry_run=false --ref main
```

# v1.7.4 Release-Asset Upload Plan
...
```bash
git tag -a v1.7.4 -m "v1.7.4"
git push origin main
git push origin v1.7.4
gh workflow run release-cd.yml -f release_tag=v1.7.4 -f channel=latest -f dry_run=false --ref main
```

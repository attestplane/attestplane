# v1.3.6 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.3.6-py3-none-any.whl
sdk/python/dist/attestplane-1.3.6.tar.gz
sdk/typescript/attestplane-attestplane-1.3.6.tgz
release/artifacts/v1.3.6/checksums.sha256
release/artifacts/v1.3.6/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.3.6 -f channel=latest -f dry_run=false --ref main
```

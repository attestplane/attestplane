# v0.1.1-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.1.1a0-py3-none-any.whl
sdk/python/dist/attestplane-0.1.1a0.tar.gz
sdk/typescript/attestplane-attestplane-0.1.1-alpha.tgz
release/artifacts/v0.1.1-alpha/checksums.sha256
release/artifacts/v0.1.1-alpha/artifact-manifest.json
```
...
gh release create v0.1.1-alpha --prerelease --title "v0.1.1-alpha" --notes-file docs/release-notes/v0.1.1-alpha.draft.md ...
...
gh workflow run manage-npm.yml -f action=dist-tag-set-latest-to-version -f version=0.1.1-alpha --ref main
```

# v0.8.1-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.8.1a0-py3-none-any.whl
sdk/python/dist/attestplane-0.8.1a0.tar.gz
sdk/typescript/attestplane-attestplane-0.8.1-alpha.tgz
release/artifacts/v0.8.1-alpha/checksums.sha256
release/artifacts/v0.8.1-alpha/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.8.1-alpha -m "v0.8.1-alpha"
git -c http.version=HTTP/1.1 push origin v0.8.1-alpha
gh release create v0.8.1-alpha --prerelease --title "v0.8.1-alpha" --notes-file docs/release-notes/v0.8.1-alpha.draft.md ...

# v1.0.2 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.0.2-py3-none-any.whl
sdk/python/dist/attestplane-1.0.2.tar.gz
sdk/typescript/attestplane-attestplane-1.0.2.tgz
release/artifacts/v1.0.2/checksums.sha256
release/artifacts/v1.0.2/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.0.2 -f channel=latest -f dry_run=false --ref main
```

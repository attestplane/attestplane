# v0.6.7-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.6.7a0-py3-none-any.whl
sdk/python/dist/attestplane-0.6.7a0.tar.gz
sdk/typescript/attestplane-attestplane-0.6.7-alpha.tgz
release/artifacts/v0.6.7-alpha/checksums.sha256
release/artifacts/v0.6.7-alpha/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.6.7-alpha -m "v0.6.7-alpha"
git -c http.version=HTTP/1.1 push origin v0.6.7-alpha
gh release create v0.6.7-alpha --prerelease --title "v0.6.7-alpha" --notes-file docs/release-notes/v0.6.7-alpha.draft.md ...

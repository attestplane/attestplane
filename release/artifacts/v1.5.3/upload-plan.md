# v1.5.3 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.5.3-py3-none-any.whl
sdk/python/dist/attestplane-1.5.3.tar.gz
sdk/typescript/attestplane-attestplane-1.5.3.tgz
release/artifacts/v1.5.3/checksums.sha256
release/artifacts/v1.5.3/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.5.3 -f channel=latest -f dry_run=false --ref main
```

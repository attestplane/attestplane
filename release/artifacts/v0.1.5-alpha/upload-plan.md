# v0.1.5-alpha Release-Asset Upload Plan
...
gh release create v0.1.5-alpha --prerelease --title "v0.1.5-alpha" --notes-file docs/release-notes/v0.1.5-alpha.draft.md ...
...
gh workflow run manage-npm.yml -f action=dist-tag-set-latest-to-version -f version=0.1.5-alpha --ref main
```

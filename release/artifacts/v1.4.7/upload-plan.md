# v1.4.7 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.4.7-py3-none-any.whl
sdk/python/dist/attestplane-1.4.7.tar.gz
sdk/typescript/attestplane-attestplane-1.4.7.tgz
release/artifacts/v1.4.7/checksums.sha256
release/artifacts/v1.4.7/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v1.4.7 -m "v1.4.7"
git push origin main
git push origin v1.4.7
gh workflow run release-cd.yml -f release_tag=v1.4.7 -f channel=latest -f dry_run=false --ref main
```

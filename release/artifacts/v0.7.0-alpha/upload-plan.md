# v0.7.0-alpha Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.7.0a0-py3-none-any.whl
sdk/python/dist/attestplane-0.7.0a0.tar.gz
sdk/typescript/attestplane-attestplane-0.7.0-alpha.tgz
release/artifacts/v0.7.0-alpha/checksums.sha256
release/artifacts/v0.7.0-alpha/artifact-manifest.json
```
...
git -c http.version=HTTP/1.1 push origin v0.7.0-alpha
gh release create v0.7.0-alpha --prerelease --title "v0.7.0-alpha" --notes-file docs/release-notes/v0.7.0-alpha.draft.md ...

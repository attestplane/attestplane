# v0.8.8 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.8.8-py3-none-any.whl
sdk/python/dist/attestplane-0.8.8.tar.gz
sdk/typescript/attestplane-attestplane-0.8.8.tgz
release/artifacts/v0.8.8/checksums.sha256
release/artifacts/v0.8.8/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v0.8.8 -m "v0.8.8"
git push origin main
git push origin v0.8.8
gh workflow run release-cd.yml -f release_tag=v0.8.8 -f channel=latest -f dry_run=false --ref main
```

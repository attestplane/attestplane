# v0.9.3 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-0.9.3-py3-none-any.whl
sdk/python/dist/attestplane-0.9.3.tar.gz
sdk/typescript/attestplane-attestplane-0.9.3.tgz
release/artifacts/v0.9.3/checksums.sha256
release/artifacts/v0.9.3/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v0.9.3 -f channel=latest -f dry_run=false --ref main
```

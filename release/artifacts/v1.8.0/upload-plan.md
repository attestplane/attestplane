# v1.8.0 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.8.0-py3-none-any.whl
sdk/python/dist/attestplane-1.8.0.tar.gz
sdk/typescript/attestplane-attestplane-1.8.0.tgz
release/artifacts/v1.8.0/checksums.sha256
release/artifacts/v1.8.0/artifact-manifest.json
```
...
gh workflow run release-cd.yml -f release_tag=v1.8.0 -f channel=latest -f dry_run=false --ref main
```

# v0.7.1-alpha Release-Asset Upload Plan
...
```bash
git tag -a v0.7.1-alpha -m "v0.7.1-alpha"
git -c http.version=HTTP/1.1 push origin v0.7.1-alpha
gh release create v0.7.1-alpha --prerelease --title "v0.7.1-alpha" --notes-file docs/release-notes/v0.7.1-alpha.draft.md ...

# v1.5.2 Release-Asset Upload Plan
...
```bash
git tag -a v1.5.2 -m "v1.5.2"
git push origin main
git push origin v1.5.2
gh workflow run release-cd.yml -f release_tag=v1.5.2 -f channel=latest -f dry_run=false --ref main
```

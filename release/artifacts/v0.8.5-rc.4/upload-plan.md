# v0.8.5-rc.4 Release-Asset Upload Plan
...
```bash
git tag -a v0.8.5-rc.4 -m "v0.8.5-rc.4"
git push origin main
git push origin v0.8.5-rc.4
gh workflow run release-cd.yml -f release_tag=v0.8.5-rc.4 -f channel=rc -f dry_run=false --ref main
```

# v1.3.9 Release-Asset Upload Plan
...
```text
sdk/python/dist/attestplane-1.3.9-py3-none-any.whl
sdk/python/dist/attestplane-1.3.9.tar.gz
sdk/typescript/attestplane-attestplane-1.3.9.tgz
release/artifacts/v1.3.9/checksums.sha256
release/artifacts/v1.3.9/artifact-manifest.json
```

## Release Commands

```bash
git tag -a v1.3.9 -m "v1.3.9"
git push origin main
git push origin v1.3.9
gh workflow run release-cd.yml -f release_tag=v1.3.9 -f channel=latest -f dry_run=false --ref main
```

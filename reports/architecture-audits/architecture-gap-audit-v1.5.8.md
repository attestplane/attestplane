...
- plan_level: `daily`
- anchor: `v1.5.0`
- head_sha: `982edab2d2addf4ebbe638a8c4f382fd36498831`
- stable releases since anchor: `8`
- real commits since anchor: `14`
- release-prep commits since anchor: `11`
...
```bash
ask_opus.sh architect "$(cat reports/architecture-audits/architecture-gap-audit-v1.5.8.md)"
```

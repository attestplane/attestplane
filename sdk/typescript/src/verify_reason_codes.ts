...
export const VERIFY_REASON_TAXONOMY_VERSION_UNSUPPORTED =
  'att.verify.taxonomy_version_unsupported' as const;
...
export type VerifyReasonCodeV1 =
  ...
  | typeof VERIFY_REASON_TAXONOMY_VERSION_UNSUPPORTED
...
export const VERIFY_REASON_TAXONOMY: Readonly<Record<VerifyReasonCodeV1, string>> = {
  ...
  [VERIFY_REASON_TAXONOMY_VERSION_UNSUPPORTED]:
    'The caller requested a supported verifier taxonomy version that this CLI does not expose.',
  [VERIFY_REASON_SIGNATURE_INVALID]:

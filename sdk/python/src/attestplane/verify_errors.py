...
VERIFY_TAXONOMY_VERSION_PINNING_FAILED: Final[VerifyErrorCode] = "VERIFY_TAXONOMY_VERSION_PINNING_FAILED"
...
VERIFY_ERROR_DESCRIPTIONS: Final[dict[VerifyErrorCode, str]] = {
    ...
    VERIFY_TAXONOMY_VERSION_PINNING_FAILED: "The requested taxonomy-version pin does not match the bundle or verifier.",
}

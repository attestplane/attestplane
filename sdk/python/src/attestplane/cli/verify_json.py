        ...
        if bundle is None:
            return [
                _explanation_entry(
                    ...
                    f"taxonomy_version={result.taxonomy_version} anchor=unknown",
                )
            ]
        return [
            _explanation_entry(None, "/", _verify_success_summary(bundle, taxonomy_version=result.taxonomy_version))
        ]

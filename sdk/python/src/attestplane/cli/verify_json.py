...
def _verify_success_summary(bundle: dict[str, Any]) -> str:
    return _verify_success_summary_with_taxonomy_version(
        bundle,
        taxonomy_version=VERIFY_REASON_TAXONOMY_VERSION,
    )


def _verify_success_summary_with_taxonomy_version(
    bundle: dict[str, Any],
    *,
...
def _verify_explanations(
    ...
    *,
    ...
    if result.ok:
        ...
        taxonomy_version = getattr(result, "taxonomy_version", VERIFY_REASON_TAXONOMY_VERSION)
        ...
        return [
            _explanation_entry(
                None,
                "/",
                _verify_success_summary_with_taxonomy_version(
                    bundle,

...
def _verify_success_summary(bundle: dict[str, Any], *, taxonomy_version: int) -> str:
    return (
        ...
        if bundle is None:
            return [
                _explanation_entry(
                    None,
                    "/",
                    f"signer_subject=unknown schema_version=unknown taxonomy version={taxonomy_version} anchor=unknown",
                )
            ]
        return [
            _explanation_entry(
                None,
                "/",
                _verify_success_summary(bundle, taxonomy_version=taxonomy_version),
            )
        ]

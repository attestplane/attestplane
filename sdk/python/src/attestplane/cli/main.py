...
Subcommands::
    ...
    verify-proofbundle <file.json> — alpha local ProofBundle verifier, JSON report, exit 0/2/3/4
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_verify_pb = sub.add_parser(
        "verify-proofbundle",
        help="alpha local ProofBundle/evidence-bundle verifier; JSON report; optional signature verification and quarantine-aware anchor verification",
        description=(
            ...
            "provenance-shape no-go claims. Optional signature and anchor paths are "
            "fail-closed and quarantine unverifiable anchors. It performs no network "
            "access or compliance certification."
        ),
    )
    ...
    p_verify_pb.add_argument(
        ...
        help=(
            ...
            "verification. Unsupported or unverifiable inputs stay fail-closed."
        ),
    )
    p_verify_pb.add_argument(
        "--verify-anchor",
        ...
        help=(
            ...
            "verification. Unverifiable anchors are quarantined instead of being "

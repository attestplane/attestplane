...
def _taxonomy_version_from_bundle(bundle: dict[str, Any]) -> int:
    metadata = bundle["chain_metadata"]
    taxonomy_version = metadata.get("evidence_taxonomy_version", 1)
...
def verify_proof_bundle(
    ...
    *,
    ...
    taxonomy_version = _taxonomy_version_from_bundle(bundle)

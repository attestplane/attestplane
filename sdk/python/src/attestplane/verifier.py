...
def _taxonomy_version_reason(
    ...
    *,
    ...
    if "evidence_taxonomy_version" not in metadata:
        return "chain_metadata.evidence_taxonomy_version is missing"
    actual = metadata["evidence_taxonomy_version"]
    if not isinstance(actual, int):
        return "chain_metadata.evidence_taxonomy_version must be an integer"
    if f"v{actual}" != require_taxonomy_version:
        return (
            f"chain_metadata.evidence_taxonomy_version={actual!r} does not match "
...
def _verify_metadata_closure(
    ...
    *,
    ...
    taxonomy_reason = _taxonomy_version_reason(
        metadata,

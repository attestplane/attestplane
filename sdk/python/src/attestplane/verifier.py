...
def _taxonomy_version_reason(
    ...
    if taxonomy_version != require_taxonomy_version:
        return (
            f"chain_metadata.evidence_taxonomy_version={taxonomy_version!r} "
            f"does not match required taxonomy version {require_taxonomy_version!r}"
        )
    return None
...
def _verify_metadata_closure(
    ...
    *,
    ...
    taxonomy_reason = _taxonomy_version_reason(metadata, require_taxonomy_version)

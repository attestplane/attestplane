...
def _anchoring_state(
    chain_metadata: dict[str, Any],
) -> tuple[Literal["verified", "quarantined", "absent"], str | None]:
    ...
    if anchor_ref.startswith("quarantine:"):
        quarantine_reason = anchor_ref.removeprefix("quarantine:").strip()
        return "quarantined", quarantine_reason or "quarantined anchor"
...
def verify_proof_bundle(
    ...
    *,
    ...
    anchoring_status, quarantine_reason = _anchoring_state(bundle["chain_metadata"])

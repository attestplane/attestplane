...
def test_verifier_result_exposes_stable_anchoring_fields() -> None:
    ...
    assert result.anchoring.quarantine_reason is None
    ...
    assert anchored_result.quarantine_reason is None
    assert anchored_result.anchoring.status == "verified"
    ...
    assert quarantined_result.quarantine_reason == quarantined_result.primary_reason
    assert quarantined_result.anchoring.status == "quarantined"
    assert quarantined_result.anchoring.quarantine_reason == quarantined_result.primary_reason

...
def run_once(args: argparse.Namespace) -> dict[str, object]:
    ...
    for issue in processable_issues(
        ...
        include_labels=None,
        exclude_labels=None,
        require_product_delta=False,
    ):
        result = run_issue(config, issue.number)
    ...
    return {
        ...
        "needs_human_recovery": {"enabled": False, "results": []},
        "advance": None,
        "product_delta_recovery": {"enabled": False, "reason": "disabled"},
        "results": results,

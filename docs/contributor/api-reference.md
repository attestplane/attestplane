...
post-release publishing workflow, [`.github/workflows/api-ref-publish.yml`](../../.github/workflows/api-ref-publish.yml),
publishes stable release-line docs after release CD succeeds.

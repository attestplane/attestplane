...
[`bestpractices.dev/projects/12924/1`](https://www.bestpractices.dev/projects/12924).
...
| Criterion | State | Evidence or gap | Blocker |
|---|---|---|---|
| `signed_releases` | partial | [ADR-0018](../adr/0018-keyless-signing-and-slsa-provenance.md) commits to Sigstore keyless cosign + SLSA Build L3 (forward-only); [`.github/workflows/sign-release.yml`](../../.github/workflows/sign-release.yml) and [`.github/workflows/slsa-provenance.yml`](../../.github/workflows/slsa-provenance.yml) exist. No release tag has yet been produced through the signed CD path. | The first signed release lands alongside v1.0 GA per the published target; no retroactive signing of pre-ADR tags. |

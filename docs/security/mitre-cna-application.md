...
| cveform field | Value to paste |
|---------------|----------------|
| Public vulnerability-disclosure policy URL | [`SECURITY.md`](../../SECURITY.md) |
...
| cveform field | Value to paste |
|---------------|----------------|
| Disclosure policy URL | [`SECURITY.md`](../../SECURITY.md) |
...
- [ ] **Disclosure policy URL stable** at [`SECURITY.md`](../../SECURITY.md) — confirmed reachable and not behind a redirect chain.
